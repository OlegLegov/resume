...
var header = {
  ...
  address: 'Kovtuna str., 34, Kharkiv, Ukraine',
}
  ...
  res.render('shoporder', {
    ...
    total: {
      ...
      item_list: [
        ...
        { name: 'Мишка', price: '250 ₴' },
        { name: 'Клава', price: '250 ₴' },
      ],
      additional_info: [
        { text: 'Всього товарів', value: '25 500 ₴' },
    ...
    quiz: {
      ...
      preference: {
        title:
          'В придбанні обладнання якого типу ви зацікавлені?',
        options: [
          'Смартфони',
          'Ноутбуки',
          'Планшети',
